...
import PropertySalesTracking from '../components/PropertySalesTracking';
...
const StatsPage = () => {
  ...
  const [pageDescription, setPageDescription] = useState('Visualize e analise os dados da sua operação no Brasil');
  ...
  const [performanceData, setPerformanceData] = useState<PerformanceData[]>([
    { name: 'Rendimento Cana-de-açúcar', current: 75, target: 85, unit: 't/ha' },
    { name: 'Qualidade Banana Exportação', current: 88, target: 95, unit: '%' },
    { name: 'Rentabilidade Abacaxi', current: 70, target: 80, unit: '%' },
    { name: 'Certificação Orgânica', current: 25, target: 40, unit: '%' },
    { name: 'Inovação Inhame', current: 60, target: 75, unit: '%' },
  ]);
