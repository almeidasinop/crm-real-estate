...
const ParcelsPage = () => {
  const { 
    ...
    defaultTitle: 'Gestão de Propriedades',
    defaultDescription: 'Gerencie, organize e otimize todas as suas propriedades agrícolas'
  });
      ...
      <div className="p-6 animate-enter">
        ...
        >
          <div className="flex items-center mb-2">
            ...
            <h2 className="text-lg font-medium">Visão Geral das Estatísticas de Propriedades</h2>
          </div>
