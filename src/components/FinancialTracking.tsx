...
// Dados mensais (valores em R$)
const monthlyData = [
  { name: 'Jan', income: 42500, expenses: 36000 },
  { name: 'Fev', income: 46000, expenses: 39000 },
  { name: 'Mar', income: 44000, expenses: 37000 },
  { name: 'Abr', income: 52500, expenses: 40500 },
  { name: 'Mai', income: 56000, expenses: 47500 },
  { name: 'Jun', income: 49000, expenses: 39500 },
  { name: 'Jul', income: 62500, expenses: 51000 },
];
...
const FinancialTracking = () => {
  ...
  const [description, setDescription] = useState('Gerencie suas receitas e despesas para otimizar a rentabilidade do seu negócio');
  
  // State for transactions
  const [transactions, setTransactions] = useState([
    { id: 1, date: '2023-07-05', description: 'Comissão de venda', amount: 16000, category: 'Vendas', type: 'income' },
    { id: 2, date: '2023-07-10', description: 'Marketing digital', amount: 4250, category: 'Marketing', type: 'expense' },
    { id: 3, date: '2023-07-12', description: 'Conta de luz escritório', amount: 1600, category: 'Utilidades', type: 'expense' },
    { id: 4, date: '2023-07-15', description: 'Comissão apartamento', amount: 7500, category: 'Vendas', type: 'income' },
    { id: 5, date: '2023-07-20', description: 'Manutenção veículo', amount: 3750, category: 'Manutenção', type: 'expense' },
    { id: 6, date: '2023-07-25', description: 'Bônus de performance', amount: 21000, category: 'Bônus', type: 'income' },
    { id: 7, date: '2023-07-28', description: 'Salários funcionários', amount: 14000, category: 'Salários', type: 'expense' },
  ]);
      ...
      <html>
        ...
        <body>
          ...
          <div class="summary">
            ...
            <p>Saldo: <b class="${balance >= 0 ? 'income' : 'expense'}">R$ ${balance.toFixed(2)}</b></p>
          </div>
          <table>
            <thead>
              <tr>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="col-span-2">
                      ...
                      <FormControl>
                        <Input placeholder="Exemplo: Vendas, Marketing..." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
