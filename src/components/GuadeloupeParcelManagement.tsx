  ...
  return (
    <div className="p-6 animate-enter">
      <header className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold mb-1">Gestão de Propriedades na Guadeloupe</h1>
          <p className="text-muted-foreground">Gerencie e monitore todas as suas propriedades agrícolas no arquipélago</p>
        </div>
        <button 
