...
const Statistics = () => {
  ...
  const getChartTitle = () => {
    switch (currentChart) {
      case 'yields': return 'Performance dos Agentes';
      case 'financial': return 'Análise Financeira';
      case 'environmental': return 'Indicadores de Mercado';
  ...
  const getChartDescription = () => {
    switch (currentChart) {
      case 'yields': return 'Performance e produtividade dos agentes imobiliários';
      case 'financial': return 'Análise detalhada das performances financeiras';
      case 'environmental': return 'Indicadores de mercado imobiliário e tendências';
      default: return 'Dados estatísticos da sua propriedade';
    }
  };
    ...
    switch (currentChart) {
      case 'yields':
        return [
          ...
          { key: "current", header: "Vendas Atuais" },
          { key: "previous", header: "Vendas Anteriores" },
          { key: "unit", header: "Unidade" }
        ];
      case 'financial':
        return [
          { key: "name", header: "Parcela" },
          { key: "profitability", header: "Rentabilidade (R$)" },
          { key: "size", header: "Área (ha)" },
          { key: "crop", header: "Especialidade" }
        ];
      case 'environmental':
        return [
