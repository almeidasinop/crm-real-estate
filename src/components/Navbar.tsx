      ...
      >
        <div className="p-4 border-b border-border flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-lg font-bold text-foreground">CRM Imobiliário</span>
          </Link>
          <button 
            onClick={toggleTheme} 
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center space-x-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate">Corretor</p>
              <p className="text-xs text-muted-foreground truncate">corretor@imobiliaria.com</p>
            </div>
          </div>
        </div>
      </aside>
