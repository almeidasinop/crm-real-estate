  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Índice de Mercado</CardTitle>
          </CardHeader>
          <CardContent className="flex flex-col items-center justify-center">
            <div className="text-center">
              ...
              <p className="mt-4 text-sm">
                Índice de aquecimento do mercado imobiliário na região.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center justify-center">
            <div className="text-center">
              ...
              <p className="mt-4 text-sm">
                Redução no tempo médio de venda de propriedades.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Certificações e Reconhecimentos</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border rounded-lg p-4 flex flex-col items-center">
              ...
              <h4 className="font-medium mb-1">CRECI Certificado</h4>
              <p className="text-sm text-center text-muted-foreground">
                Licenciado desde 2019
              </p>
            </div>
            <div className="border rounded-lg p-4 flex flex-col items-center">
              ...
              <h4 className="font-medium mb-1">Top Performance</h4>
              <p className="text-sm text-center text-muted-foreground">
                Equipe Destaque 2023
              </p>
            </div>
            <div className="border rounded-lg p-4 flex flex-col items-center">
              ...
              <h4 className="font-medium mb-1">Expansão Digital</h4>
              <p className="text-sm text-center text-muted-foreground">
                80% das vendas online
              </p>
            </div>
          </div>
        </CardContent>
