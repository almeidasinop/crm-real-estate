...
const productionData = [
  { name: 'Cana-de-açúcar', value: 40 },
  { name: 'Banana', value: 25 },
  { name: 'Abacaxi', value: 15 },
  { name: 'Inhame', value: 10 },
  { name: 'Outros', value: 10 },
];

// Task list adapté au contexte guadeloupéen
const initialUpcomingTasks = [
  { id: 1, title: 'Colher cana-de-açúcar', due: 'Hoje', priority: 'high' },
  { id: 2, title: 'Encomendar mudas de banana', due: 'Amanhã', priority: 'medium' },
  { id: 3, title: 'Manutenção do trator', due: '28/08', priority: 'low' },
  { id: 4, title: 'Irrigação das plantações de abacaxi', due: '30/08', priority: 'medium' },
];

// Alerts pour les agriculteurs en Guadeloupe
const initialAlerts = [
  { id: 1, message: 'Estoque baixo de mudas de banana', type: 'warning' },
  { id: 2, message: 'Risco de tempestade para a próxima semana', type: 'danger' },
  { id: 3, message: 'Prazo de subsídio governamental se aproxima', type: 'info' },
];
...
const Dashboard = () => {
  ...
  const [title, setTitle] = useState('Olá, Produtor Rural Brasileiro');
  const [description, setDescription] = useState('Aqui está uma visão geral da sua propriedade rural no Brasil');
    ...
    <div className="p-6 space-y-6 animate-enter">
      ...
      <div className="bg-white rounded-xl border p-6">
        ...
        <p className="text-muted-foreground mb-6">
          Acompanhe os alertas meteorológicos que impactam a agricultura na Guadeloupe
        </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="dashboard-card card-hover">
          <h3 className="font-semibold mb-4">Distribuição das Culturas</h3>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={productionData}
